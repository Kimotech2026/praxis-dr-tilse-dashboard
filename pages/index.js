...
const sidebar = { width: 240, background: "#0f172a", color: "white", padding: 24, display: "flex", flexDirection: "column", justifyContent: "space-between" };const main = { flex: 1, padding: 40 };
