...
const card = { background: "white", padding: "20px 16px", borderRadius: 16, boxShadow: "0 8px 24px rgba(0,0,0,0.06)" };
const highlightCard = { gridColumn: "1 / -1", display: "flex", justifyContent: "space-between", alignItems: "center", background: "linear-gradient(135deg, #2563eb, #1e40af)", color: "white", padding: "18px 22px", borderRadius: 16, boxShadow: "0 12px 30px rgba(37,99,235,0.30)" };
