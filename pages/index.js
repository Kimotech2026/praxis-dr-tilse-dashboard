...
const contactHeaderRow = { display: "grid", gridTemplateColumns: "140px 145px 130px 150px 135px 300px", gap: 14, fontSize: 13, color: "#667085", marginBottom: 10, padding: "0 16px" };
const contactRow = { display: "grid", gridTemplateColumns: "140px 145px 130px 150px 135px 300px", gap: 14, padding: 16, borderBottom: "1px solid #e5e7eb", alignItems: "center" };
