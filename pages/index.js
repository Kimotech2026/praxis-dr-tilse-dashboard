...
const contactHeaderRow = { display: "grid", gridTemplateColumns: "150px 150px 160px 150px 130px 140px", gap: 18, fontSize: 13, color: "#667085", marginBottom: 10, padding: "0 16px" };
const contactRow = { display: "grid", gridTemplateColumns: "150px 150px 160px 150px 130px 140px", gap: 18, padding: 16, borderBottom: "1px solid #e5e7eb", alignItems: "center" };
