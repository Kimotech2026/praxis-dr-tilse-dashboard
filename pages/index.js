...
const callTop = { display: "grid", gridTemplateColumns: "90px 220px 380px 1fr 170px", gap: 12, alignItems: "center" };
...
const headerRow = { display: "grid", gridTemplateColumns: "90px 220px 380px 1fr 170px", gap: 12, fontSize: 13, color: "#667085", marginBottom: 10, padding: "0 16px" };
