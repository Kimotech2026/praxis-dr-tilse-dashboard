...
const highlightCard = { display: "flex", justifyContent: "space-between", alignItems: "center", background: "linear-gradient(135deg, #2563eb, #1e40af)", color: "white", padding: "18px 22px", borderRadius: 16, boxShadow: "0 12px 30px rgba(37,99,235,0.30)" };
