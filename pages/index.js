...
const contactHeaderRow = { display: "grid", gridTemplateColumns: "140px 145px 130px 150px 135px 130px", gap: 14, fontSize: 13, color: "#667085", marginBottom: 10, padding: "0 16px" };
const contactRow = { display: "grid", gridTemplateColumns: "140px 145px 130px 150px 135px 130px", gap: 14, padding: 16, borderBottom: "1px solid #e5e7eb", alignItems: "center" };const unreadBadge = { position: "absolute", top: -7, right: -7, background: "#dc2626", color: "white", borderRadius: 999, minWidth: 20, height: 20, padding: "0 6px", fontSize: 12, fontWeight: 700, display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 4px 10px rgba(220,38,38,0.35)" };
