...
const callTop = { display: "grid", gridTemplateColumns: "90px 240px 220px 1fr 170px", gap: 12, alignItems: "center" };
const badge = { width: 90, height: 28, flexShrink: 0, display: "inline-flex", justifyContent: "center", alignItems: "center", borderRadius: 999, fontSize: 13, fontWeight: 500 };
...
const headerRow = { display: "grid", gridTemplateColumns: "90px 220px 330px 1fr 170px", gap: 12, fontSize: 13, color: "#667085", marginBottom: 10, padding: "0 16px" };
