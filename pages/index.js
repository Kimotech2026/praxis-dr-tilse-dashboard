...
export default function Home() {
  ...
  const [activePage, setActivePage] = useState(() => JSON.parse(localStorage.getItem("dashboardSettings") || "{}").startPage || "Anrufe");
...
const smallSelect = { width: "130px", minWidth: "130px", maxWidth: "180px", flexShrink: 0, marginLeft: "auto", padding: "10px 14px", borderRadius: 12, border: "1px solid #dbe1ea", background: "#f8fafc", fontSize: 14, outline: "none", boxSizing: "border-box" };
