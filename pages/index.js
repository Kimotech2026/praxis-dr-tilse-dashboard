...
const toast = { position: "fixed", right: 24, bottom: 24, background: "#dcfce7", color: "#166534", border: "1px solid #86efac", padding: "12px 18px", borderRadius: 12, boxShadow: "0 12px 30px rgba(15,23,42,0.18)", fontWeight: 400, fontSize: 13, zIndex: 100, minWidth: 260, textAlign: "center", transform: "translateY(0)", opacity: 1, transition: "all 0.5s ease" };
